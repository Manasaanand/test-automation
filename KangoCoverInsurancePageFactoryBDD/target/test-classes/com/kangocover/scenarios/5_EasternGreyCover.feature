...
To Buy L4-Eastern Grey Cover Insurance on various conditions like age and number of travellers and validate
...
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover", "Business Cover" and "High Value Items" from Annual 60 days (Excludes Wintersports) Cover and validate values from Q2, Q3
and Confirmation Page

When I enter "India" as my destination
And I enter my Return Dates as "60" days from today
