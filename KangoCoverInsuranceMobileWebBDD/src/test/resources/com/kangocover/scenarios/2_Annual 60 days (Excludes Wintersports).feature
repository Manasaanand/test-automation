Feature: ANNUAL 60 DAYS - EXCLUDES  WinterSports 
To Buy Annual 60 days (Excludes Wintersports) Insurance on various conditions like age and number of travellers and validate
...
@ANNUAL60DAYS_EXCLUDES_Wintersports_singletraveller
Scenario: To Buy "Winter Sports Cover",  "Sports and Activity Cover" and "High Value Items" from Annual 60 days (Excludes Wintersports) and validate values from Q2, Q3
...
@ANNUAL60DAYS_EXCLUDES_Wintersports_familytraveller
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 60 days (Excludes Wintersports) and validate values from Q2, Q3
...
@ANNUAL60DAYS_EXCLUDES_Wintersports_duotraveller
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 60 days (Excludes Wintersports) and validate values from Q2, Q3
