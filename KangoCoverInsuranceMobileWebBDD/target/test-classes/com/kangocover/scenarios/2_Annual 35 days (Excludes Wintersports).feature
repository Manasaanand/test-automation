Feature: ANNUAL 35 DAYS - EXCLUDES Wintersports 
To Buy Annual 35 days (Excludes Wintersports) Insurance on various conditions like age and number of travellers and validate
...
@ANNUAL35DAYS_EXCLUDES_Wintersports_singletraveller
Scenario: To Buy "Winter Sports Cover",  "Sports and Activity Cover" and "High Value Items" from Annual 35 days (Excludes Wintersports) and validate values from Q2, Q3
...
@ANNUAL35DAYS_EXCLUDES_Wintersports_familyravellers
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 35 days (Excludes Wintersports)and validate values from Q2, Q3
...
@ANNUAL35DAYS_EXCLUDES_Wintersports_duotravellers
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 35 days (Excludes Wintersports)and validate values from Q2, Q3
