Feature: ANNUAL 35 DAYS - INCLUDES WinterSports 
To Buy Annual 35 days (Includes Wintersports) Insurance on various conditions like age and number of travellers and validate
...
@ANNUAL35DAYS_INCLUDES_Wintersports_singletraveller
Scenario: To Buy "Winter Sports Cover",  "Sports and Activity Cover" and "High Value Items" from Annual 35 days (Includes Wintersports) and validate values from Q2, Q3
...
@ANNUAL35DAYS_INCLUDES_Wintersports_familytravellers
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 35 days (Includes Wintersports)and validate values from Q2, Q3
...
@ANNUAL35DAYS_INCLUDES_Wintersports_duotravellers
Scenario: To Buy "Winter Sports Cover", "Sports and Activity Cover"  and "High Value Items" from Annual 35 days (Includes Wintersports)and validate values from Q2, Q3
